...
#                    new(:employee_id, Employee.table_name(*partition_key_values), :id)
#      }
#    end
#  end
#
...
class Award < ByEmployeeCreatedAt
  ...
  partitioned do |partition|
    partition.foreign_key lambda {|model, *partition_key_values|
      return Configurator::Data::ForeignKey.new(:employee_id, Employee.table_name(*partition_key_values), :id)
    }
  end
